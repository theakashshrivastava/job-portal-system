...
* The original package name 'com.employer-service' is invalid and this project uses 'com.employer' instead.
...
```
$ docker run --rm -p 8080:8080 employer-service:0.0.1-SNAPSHOT
```
